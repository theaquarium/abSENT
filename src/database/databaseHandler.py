...
class DatabaseHandler():
    ...
    def getTeacher(self, teacher: Teacher):
        ...
        if res != None:
            teacher = Teacher(
                res[1], res[2], SchoolNameMapper()[res[3]], res[0])
            return teacher
        return None
    ...
    def getStudent(self, student: Student):
        ...
        if res != None:
            student = Student(res[1], res[2], res[3], SchoolNameMapper()[
                              res[4]], res[5], res[0])
            return student
        return None
    ...
    def getStudentsByGrade(self, grade: int) -> list:
        ...
        for student in res:
            ...
            entry = Student(student[1], student[2], student[3],
                            student[4], student[5], student[0])
    ...
    def queryStudentsByAbsentTeacher(self, teacher: Teacher, block: SchoolBlock) -> List[Student]:
        ...
        for col in res:
            students.append(
                Student(col[1], col[2], col[3], col[4], col[5], col[0]))
        return students
    ...
    def getTeachersFromStudent(self, student: Student):
        ...
        for teacher in res:
            teachers.append(
                Teacher(teacher[1], teacher[2], SchoolNameMapper()[teacher[3]], teacher[0]))
        return teachers
